      ...
      <AppBar position="fixed" sx={{ zIndex: theme.zIndex.drawer + 1, display: { md: 'none' } }}>
        <Toolbar>
          <Tooltip title="Abrir menú">
            <IconButton color="inherit" onClick={() => setMobileOpen(!mobileOpen)} sx={{ mr: 2 }} aria-label="Abrir menú">
              <MenuIcon />
            </IconButton>
          </Tooltip>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>SGE</Typography>
          ...
          <Tooltip title="Menú de usuario">
            <IconButton color="inherit" onClick={(e) => setAnchorEl(e.currentTarget)} aria-label="Menú de usuario">
