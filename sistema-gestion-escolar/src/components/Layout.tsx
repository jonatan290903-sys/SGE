      ...
      <AppBar position="fixed" sx={{ zIndex: theme.zIndex.drawer + 1, display: { md: 'none' } }}>
        <Toolbar>
          <Tooltip title="Abrir menú">
            <IconButton color="inherit" onClick={() => setMobileOpen(!mobileOpen)} sx={{ mr: 2 }} aria-label="Abrir menú de navegación">
              <MenuIcon />
            </IconButton>
          </Tooltip>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>SGE</Typography>
          ...
          <Tooltip title="Perfil de usuario">
            <IconButton color="inherit" onClick={(e) => setAnchorEl(e.currentTarget)} aria-label="Perfil de usuario">
